...
import { BookingProps, LocationDetails, Suggestion } from '../../utilities/interface';
import { ZoomInMotionWrapper } from '../../reuseComponents/ui/MotionWrapper ';
import LocationInput from '../../reuseComponents/LocationInput';



const Locationfind:React.FC<BookingProps> = ({setActiveSection}) => {
...
// };
    ...
    //     dispatch(setEstimateAddress({description:input,coordinates}))
