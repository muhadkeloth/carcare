...
import { faArrowRight, faCar, faIndianRupee, faIndianRupeeSign, faStar } from '@fortawesome/free-solid-svg-icons';
import { useNavigate } from 'react-router-dom';
import { navigateBookingSlot } from '../../utilities/navigate/userNavigator';


const FindEstimate:React.FC<estimateProps> = ({setActiveSection}) => {
...
<div className="border rounded-lg h-fit p-5 max-w-xl md:w-2/3 my-4 ">   
               ...
               <p className='text-gray-600 mt-2'><FontAwesomeIcon icon={faCar} /> {`${repairWork?.work}`} </p>
               </div>  
    </div>
