...
import { FloatMotionWrapper } from './ui/MotionWrapper ';
...
const Error:React.FC<RoleProps> = ({role}) => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {role == "user" ? <Header /> : <NavLogin showBar={true} />}
      <div className="flex-grow flex justify-center items-center ">
        <div className="m-10 flex justify-center  border rounded-lg h-fit p-5 max-w-xl md:w-2/3  mb-4 ">
          <div className="flex-col flex gap-5 justify-center rounded-lg h-fit p-5 max-w-xl md:w-2/3 mb-4 ">
            ...
            <img
              src="https://res.cloudinary.com/drhtxuege/image/upload/v1733304480/9283b08aff5edbc0_kiaink.png"
              alt="Page Not Found"
              className="w-full h-auto"
            />
            <FloatMotionWrapper className='flex justify-center w-full'>
            <button className="btn-primary w-full" onClick={handleGoBack}>
